...
data class CurrentWeatherData(
    @SerializedName("last_updated_epoch") val lastUpdatedEpoch: Double?,
    @SerializedName("last_updated") val lastUpdated: String?,
    @SerializedName("temp_c") val tempC: Double?,
    @SerializedName("temp_f") val tempF: Double?,
    @SerializedName("is_day") val isDay: Double?,
    @SerializedName("condition") val conditionData: ConditionData?,
    ...
    @SerializedName("dewpoDouble_c") val dewpoDoubleC: Double?,
    @SerializedName("dewpoDouble_f") val dewpoDoubleF: Double?,
